        ...
        {dropdownMenu && (
          <div className="navbar_right_accountmenu">
            {!user ? (
              ...
              <>
                <Link to={`/${user.id_user}/trips`}>Trip List</Link>
                <Link to={`/${user.id_user}/wishList`}>Wish List</Link>
                <Link to={`/${user.id_user}/properties`}>Property List</Link>
                <Link to={`/${user.id_user}/reservations`}>Reservation List</Link>
