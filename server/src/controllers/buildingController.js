...
const { Property, District, City, Floor } = require("../models");
...
exports.createBuilding = async (req, res) => {
    try {
        const { name, street_address, district, city, description, host_id } = req.body;
        ...
        res.status(500).json({ message: "Server error when creating building" });
    }
};
// Giải thích:
